    ...
    >
      ...
      >
        <div className="flex items-center gap-2 px-4 py-3 border-b border-border/50 bg-secondary/30">
          ...
          <span className="ml-3 text-xs font-mono text-muted-foreground/60">developer.ts</span>
        </div>
        <pre className="p-6 text-[13px] md:text-sm font-mono leading-relaxed overflow-x-auto">
          <code>
            ...
            <span className="text-sky-300">zahidul</span>:{" "}
            <span className="text-primary">Developer</span> = {"{"}
            {"\n"}  name: <span className="text-emerald-300">"Zahidul Islam Rabbi"</span>,
            {"\n"}  role: <span className="text-emerald-300">"Mobile &amp; Backend Developer"</span>,
            {"\n"}  stack: [<span className="text-emerald-300">"Flutter"</span>,{" "}
            ...
            {"\n"}
            <span className="text-sky-300">zahidul</span>.
            <span className="text-primary">isAvailable</span>();{" "}
